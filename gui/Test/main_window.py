...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.select_dir__label.setGeometry(QtCore.QRect(30, 100, 141, 16))
        self.select_dir__label.setObjectName("select_dir__label")
        self.output__label = QtWidgets.QLabel(self.centralwidget)
        #self.output__label.setEnabled(True)
        self.output__label.setGeometry(QtCore.QRect(30, 170, 61, 16))
        font = QtGui.QFont()
        ...
        self.lineEdit.setGeometry(QtCore.QRect(110, 210, 291, 21))
